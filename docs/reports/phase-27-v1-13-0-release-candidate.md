...
| 게이트 | 명령 | 관측 결과 |
|---|---|---|
| Backend 전체 | `node scripts/qa/run_v113_backend_gates.mjs --sha <SHA> --suite all` | backend 550 passed, package·migration-heads·migration exit 0 |
| Frontend 전체 | `npm test && npm run typecheck && npm run build` | Vitest 382 passed / 73 files, TypeScript 0 error, Next 15.2.9 production build 성공 |
