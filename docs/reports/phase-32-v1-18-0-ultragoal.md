...
P0~P2 항목을 durable multi-goal(ultragoal) 9개 목표로 분해해 1.18.0 까지 완주했다. 각 목표는
...
|G004|런처 상태 배지 + 최근 열람 스트립, 1.17.0 릴리스 표기|`7641516`·`0c6daab`|
|G005|문서 수정일 메타·폴더 트리 상태 보존·뉴스레터 이슈 내비, 1.17.1|`bd06d60`·`33def5c`|
...
|G009|릴리스 성능 예산 게이트 승격 + Leantime 단일 워커 한계 명시 + 1.18.0 릴리스 준비|본 단계|
