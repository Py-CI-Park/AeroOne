...
> 아래 파일별 건수는 1.8.0 시점 스냅샷이라 합계 행이 최신 전체 수와 다를 수 있습니다. 현재 권위 있는 전체 수는 backend **265** / frontend **310 (65 files)** 이며 아래 합계 행에도 이를 반영했습니다.
...
| **backend 합계 (현재)** | **265** | `pytest tests` 전체 통과 |
| **frontend 합계 (현재)** | **310 / 65 files** | `npm test` 전체 통과 |
