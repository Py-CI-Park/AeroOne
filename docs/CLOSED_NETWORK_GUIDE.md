...
|---|---|---|---|
| `AeroOne-offline-1.8.0-YYYYMMDD-HHMMSS.zip` + `.sha256` | AeroOne GitHub Release `1.8.0` asset 또는 온라인 PC `dist\` | `D:\AeroOne\` 로 압축 해제 후 `setup_offline.bat` | 필수 |
...
| **backend 합계** | **177** | `pytest tests` 전체 통과 |
| **frontend 합계** | **205 / 47 files** | `npm test` 전체 통과 |
