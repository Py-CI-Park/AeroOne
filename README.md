...
`1.12.2` 반입물은 철회되어 사용할 수 없습니다. 현재 최신 운영 반입물은 2026-07-14 게시된 immutable 정식 `1.13.2` Release의 `AeroOne-offline-1.13.2.zip`과 함께 업로드된 `.sha256` 파일입니다. Release API는 `immutable=true`를 반환했고, published 시각은 `2026-07-14T01:40:21Z`입니다. PR #28은 no-ff merge commit `a3dd77b93027dccffb36d663bb7ee1220c9fcdf5`로 병합되었고 annotated tag object는 `62ba67eef7e2c2ac2357dc67d1cffb1c9eeedcc5`이며 위 merge commit으로 peel됩니다. ZIP size는 `158728639` bytes, SHA-256은 `92d5178d6fb67573a1f0b36e0a744e00b4b559548081b463d45a4ba1d669d8a4`, sidecar asset SHA-256은 `02bb4827b149bbe36ffad1bdb7d6dd43b95a5c3c71b168671e7da854a4f2c6d5`입니다. GitHub immutable releases 정책은 활성화되었으며, immutable historical patch `1.13.1`의 published 시각 `2026-07-13T23:31:18Z`과 ZIP SHA-256 `b05445b53ecca02175afcd016ac0e896163010e1a06a0b996b8ebe79a798e290`은 그대로 보존하고, `1.13.0`은 정책 활성화 전에 게시되어 `immutable=false`인 역사 릴리스로 tag·asset·digest를 그대로 보존합니다. Release publication은 사람이 air-gapped network에 물리적으로 import했다는 뜻이 아니며, 로컬 중간 ZIP은 운영 배포본이 아닙니다.

| 파일 | 어디서 받는가 | 폐쇄망에서 놓을 위치 | 역할 |
|---|---|---|---|
| `AeroOne-offline-1.13.2.zip` + `.sha256` | [정식 immutable GitHub Release `1.13.2`](https://github.com/Py-CI-Park/AeroOne/releases/tag/1.13.2) asset (ZIP size `158728639` bytes, SHA-256 `92d5178d6fb67573a1f0b36e0a744e00b4b559548081b463d45a4ba1d669d8a4`; sidecar SHA-256 `02bb4827b149bbe36ffad1bdb7d6dd43b95a5c3c71b168671e7da854a4f2c6d5`) | `D:\AeroOne\` 로 압축 해제 | allow-list로 검증된 AeroOne 소스, production wheelhouse/node_modules, prebuilt `.next`, 정확한 Python/Node 인스톨러 |
