...
| 검증 | 1.13.0 RC backend **567 passed**, frontend **397 passed / 73 files**, `tsc --noEmit`, `next build`; production Chrome smoke/matrix/Axe/Lighthouse/React 진단 및 QA 오프라인 ZIP pre/post verifier 통과 |
