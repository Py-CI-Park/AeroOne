...
| 검증 | 1.13.0 RC backend **550 passed**, frontend **382 passed / 73 files**, `tsc --noEmit`, `next build`; production Chrome smoke/matrix/Axe/Lighthouse/React 진단 및 QA 오프라인 ZIP pre/post verifier 통과 |
...
1. **온라인 PC**
   ...
   offline_package.bat  :: exact 1.13.0 tag에서 dist\AeroOne-offline-1.13.0.zip 생성
   ```
