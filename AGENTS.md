...
현재 `1.13.0-dev` 릴리스 후보에서 backend **570 passed**, frontend **397 passed / 73 files**를 유지합니다. 회귀 발생 시 [`docs/INDEX.md`](docs/INDEX.md) §7 표와 [`docs/reports/INDEX.md`](docs/reports/INDEX.md) 를 참고해 어느 단계의 회귀인지 진단합니다.
...
- backend `pytest tests` — 현재 release phase report의 전체 건수(**1.13.0 RC: 570 passed**) 유지 (실패 0).
