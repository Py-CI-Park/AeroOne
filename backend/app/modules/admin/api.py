...
DEFAULT_SERVICE_MODULES = [
    ...
    {'key': 'office-report', 'title': '보고서 스튜디오', 'description': 'Markdown 을 사내 표준 HTML 보고서로 변환.', 'href': '/office-tools/report', 'section': 'Development', 'status': 'development', 'badge': 'Active', 'sort_order': 110, 'is_enabled': True, 'is_external': False, 'visibility': 'admin', 'required_permission': None, 'resource_type': None, 'resource_id': None},
    {'key': 'office-chart', 'title': '차트 스튜디오', 'description': 'CSV·표 데이터를 ECharts 차트로 시각화.', 'href': '/office-tools/chart', 'section': 'Development', 'status': 'development', 'badge': 'Active', 'sort_order': 120, 'is_enabled': True, 'is_external': False, 'visibility': 'admin', 'required_permission': None, 'resource_type': None, 'resource_id': None},
    {'key': 'office-diagram', 'title': '다이어그램 스튜디오', 'description': '설명을 Mermaid 다이어그램으로 생성.', 'href': '/office-tools/diagram', 'section': 'Development', 'status': 'development', 'badge': 'Active', 'sort_order': 130, 'is_enabled': True, 'is_external': False, 'visibility': 'admin', 'required_permission': None, 'resource_type': None, 'resource_id': None},
    {'key': 'leantime', 'title': 'Leantime', 'description': '프로젝트 관리(외부 폐쇄망 앱). 운영자 설치 필요.', 'href': 'http://localhost:8081', 'section': 'Development', 'status': 'development', 'badge': 'External', 'sort_order': 140, 'is_enabled': True, 'is_external': True, 'visibility': 'admin', 'required_permission': None, 'resource_type': None, 'resource_id': None},
