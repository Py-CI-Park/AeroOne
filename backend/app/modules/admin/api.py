...
DEFAULT_SERVICE_MODULES = [
    ...
    {'key': 'office-tools', 'title': '오피스 도구', 'description': '보고서·차트·다이어그램을 한 곳에서 (샘플 예제 포함).', 'href': '/office-tools', 'section': 'Development', 'status': 'development', 'badge': 'Active', 'sort_order': 110, 'is_enabled': True, 'is_external': False, 'visibility': 'admin', 'required_permission': None, 'resource_type': None, 'resource_id': None},
