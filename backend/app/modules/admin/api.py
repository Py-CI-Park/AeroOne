...
DEFAULT_SERVICE_MODULES = [
    ...
    {'key': 'leantime', 'title': 'Leantime', 'description': '프로젝트·업무 관리(동거 앱). 안내·열기 페이지.', 'href': '/leantime', 'section': 'Development', 'status': 'development', 'badge': 'Active', 'sort_order': 140, 'is_enabled': True, 'is_external': False, 'visibility': 'admin', 'required_permission': None, 'resource_type': None, 'resource_id': None},
