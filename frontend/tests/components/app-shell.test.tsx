...
test('renders compact theme selector after Newsletter link when a path is provided', () => {
  render(
  ...
  expect(newsletter.compareDocumentPosition(selector) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy();
