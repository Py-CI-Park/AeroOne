...
function mockAdminData() {
  vi.mocked(api.fetchAdminOverview).mockResolvedValue({
    ...
    system: { app_version: '1.11.0', app_env: 'test', database_kind: 'sqlite', newsletter_count: 0, asset_health: { ok: 0, missing: 0, checksum_mismatch: 0, misconfig: 0 }, read_summary: { rows: 0, total_reads: 0 } },
    recent_audit: [],
  } as never);
