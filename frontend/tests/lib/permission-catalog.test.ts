import { PERMISSION_CATALOG, describePermission, groupPermissionsByCategory } from '@/lib/permission-catalog';

test('permission catalog covers the admin permission taxonomy', () => {
  expect(Object.keys(PERMISSION_CATALOG)).toHaveLength(36);
});
