...
const MANUAL_SECTIONS = [
  ...
  },
  {
    ...
    rows: [
      ...
      ['비밀번호 변경', '일상 변경은 관리자 계정 / 비밀번호 섹션에서 수행하며 다른 세션이 즉시 만료됩니다. 초기 자격은 UI나 문서에 고정하지 않습니다. 노출이 의심되면 서비스를 중지하고 docs/runbook/credential-rotation.md 자격 증명 사고 대응 런북에 따라 전체 사용자와 세션을 회전하세요.'],
