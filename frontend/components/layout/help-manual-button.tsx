...
const MANUAL_SECTIONS = [
  ...
  },
  {
    ...
    rows: [
      ...
      ['비밀번호 변경', '관리자 계정 / 비밀번호 섹션에서 현재 비밀번호를 확인한 뒤 새 비밀번호(8자 이상)로 교체합니다. 변경 즉시 다른 세션은 로그아웃됩니다. 설정 과정에서 backend/.env 의 ADMIN_PASSWORD 에 무작위 초기 비밀번호가 생성되며, 운영자는 첫 로그인 후 반드시 교체하세요.'],
