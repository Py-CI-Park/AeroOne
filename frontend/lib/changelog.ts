...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2026-06-16',
    items: [
      '새 "Viewer"(뷰어-에디터) 탭 추가(대시보드 Document 섹션 카드 → /viewer) — 로컬 Markdown(.md)·HTML(.html) 파일을 끌어다 놓거나 선택해 편집하고, 미리보기로 렌더 결과를 확인한 뒤 파일로 내려받을 수 있습니다. 미리보기는 격리된 안전 영역에서 표시되어 문서에 포함된 스크립트가 실행되지 않습니다(폐쇄망 안전).',
  ...
  },
  {
    ...
    items: [
      ...
      'NotebookLM 대안인 Open Notebook 을 폐쇄망에 나란히(co-deploy) 배포할 수 있게 했습니다 — 대시보드 AeroAI 섹션의 Notebook 카드로 연결되며, 설치 시 채팅·임베딩 모델이 자동 등록됩니다.',
    ],
  },
  {
    version: '1.4.3',
